...
#SBATCH -o /dais/fs/scratch/dduka/logs/verl/spatial_%A_%a.out
#SBATCH -e /dais/fs/scratch/dduka/logs/verl/spatial_%A_%a.err
...
TRAIN_FILE="/u/dduka/project/RL/TTRV/verl/data/tag/fps_vs_max_pixels/train_run2_spatial.parquet"
VAL_FILE="/u/dduka/project/RL/TTRV/verl/data/tag/fps_vs_max_pixels/test_run2_spatial.parquet"
