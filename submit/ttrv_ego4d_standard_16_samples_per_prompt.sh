...
#SBATCH -J verl_standard_16_samples_per_prompt
...
N_SAMPLES_PER_PROMPT=16 # Number of responses kept for the PPO training: used in self._select_top_k_per_prompt(...)
MINI_BATCH_SIZE=16
MICRO_BATCH_SIZE=4
...
EXPERIMENT="TTRL-ORIGINAL-SEGMENTSN-N-SAMPLES-PER-PROMPT-${N_SAMPLES_PER_PROMPT}"
