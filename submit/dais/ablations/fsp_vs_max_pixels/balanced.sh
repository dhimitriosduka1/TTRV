...
#SBATCH -o /dais/fs/scratch/dduka/logs/verl/balanced_%A_%a.out
#SBATCH -e /dais/fs/scratch/dduka/logs/verl/balanced_%A_%a.err
...
TRAIN_FILE="/u/dduka/project/RL/TTRV/verl/data/tag/fps_vs_max_pixels/train_run3_balanced.parquet"
VAL_FILE="/u/dduka/project/RL/TTRV/verl/data/tag/fps_vs_max_pixels/test_run3_balanced.parquet"
