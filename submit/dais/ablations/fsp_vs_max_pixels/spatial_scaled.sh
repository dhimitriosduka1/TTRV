...
#SBATCH -o /dais/fs/scratch/dduka/logs/verl/spatial_scaled_%A_%a.out
#SBATCH -e /dais/fs/scratch/dduka/logs/verl/spatial_scaled_%A_%a.err

#SBATCH -J spatial_scaled
...
TRAIN_FILE="/u/dduka/project/RL/TTRV/verl/data/tag/fps_vs_max_pixels/train_run2_spatial_scaled.parquet"
VAL_FILE="/u/dduka/project/RL/TTRV/verl/data/tag/fps_vs_max_pixels/test_run2_spatial_scaled.parquet"
